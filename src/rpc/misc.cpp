...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
			...
			// SYSCOIN
			"  \"v2address\" : \"syscoinaddress\", (string) The bitcoin address associated with this syscoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"")
            + HelpExampleRpc("validateaddress", "\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"")
        );
    ...
    if (isValid)
    {
		...
		ret.push_back(Pair("v2address", btcaddr.ToString()));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\\\",\\\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\\\",\\\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (string) The difference of satoshis\n"
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}")
        );

    std::vector<std::pair<uint160, int> > addresses;

	getAddressesFromParams(params, addresses);
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "    \"satoshis\"  (string) The number of satoshis of the output\n"
            "  }\n"
            "]\n"
            "\nExamples:\n"
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W\"]}")
        );
