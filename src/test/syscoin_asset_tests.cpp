...
BOOST_AUTO_TEST_CASE(generate_assetupdate)
{
	...
	BOOST_CHECK_NO_THROW(r = CallRPC(node, "assetinfo assetupdatename false"));
	BOOST_CHECK_EQUAL(AmountFromValue(find_value(r.get_obj(), "balance")), AmountFromValue(ValueFromString("7")));
