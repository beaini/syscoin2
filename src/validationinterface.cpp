...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifySyscoinUpdate.connect(boost::bind(&CValidationInterface::NotifySyscoinUpdate, pwalletIn, _1));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
	...
	g_signals.NotifySyscoinUpdate.disconnect(boost::bind(&CValidationInterface::NotifySyscoinUpdate, pwalletIn, _1));
...
void UnregisterAllValidationInterfaces() {
	...
	g_signals.NotifySyscoinUpdate.disconnect_all_slots();
